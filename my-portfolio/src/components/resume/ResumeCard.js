...
const ResumeCard = ({ title, subTitle, result, des, credentialLink }) => {
  return (
        ...
        <div className="flex flex-col lgl:flex-row justify-between gap-4 lgl:gap-0 lgl:items-center">
          ...
          <div>
            {credentialLink ? (
              ...
              >
                <p className="px-4 py-2 text-designColor bg-black bg-opacity-25 rounded-lg flex justify-center items-center shadow-shadowOne text-sm font-medium cursor-pointer hover:bg-designColor hover:text-white hover:scale-105 transform transition-all duration-300">
                  {result} 🔗
                </p>
              </a>
            ) : (
